...
SubjInfo=get(handles.RegistrationInfo,'UserData');
SubjInfo.SDGdisplay.PlotLst=find(ismember(SubjInfo.Probe.MeasList(:,2),idx) &...
    ismember(SubjInfo.Probe.MeasList(:,4),Lambda));
set(handles.RegistrationInfo,'UserData',SubjInfo);
PlotSDG(handles);
return
...
SubjInfo=get(handles.RegistrationInfo,'UserData');
SubjInfo.SDGdisplay.PlotLst=find(ismember(SubjInfo.Probe.MeasList(:,1),idx) &...
    ismember(SubjInfo.Probe.MeasList(:,4),Lambda));
set(handles.RegistrationInfo,'UserData',SubjInfo);
PlotSDG(handles);
return
