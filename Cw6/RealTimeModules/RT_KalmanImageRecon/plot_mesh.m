...
face_color      = .7; %getoptions(options, 'face_color', .7);
edge_color      = 0; %getoptions(options, 'edge_color', 0);
normal_scaling  = .8; %getoptions(options, 'normal_scaling', .8);
sanity_check = 1; %getoptions(options, 'sanity_check', 1);
