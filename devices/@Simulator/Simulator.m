...
[actx,actxCont]=javacomponent(javax.swing.JEditorPane);
set(actxCont,'position',[50 50 350 350],'parent',handle);
set(handle,'UserData',actx);
return

function handle=makeDAQhandle
%This function makes the handle to the data logger
handle=timer('TimerFcn',@mycallback, 'Period', 0.1,'TasksToExecute',360/.1,'ExecutionMode','fixedRate');
return
